...
public class InsertionSorting implements Command{
    private static final Logger logger = LogManager.getLogger(InsertionSorting.class);

    /**
     * The function calls a factory, which gives the necessary Insertion sorting
    ...
    public String execute(boolean order) {
        ...
        try {
            ...
            insertionSort.sort(array,order);
