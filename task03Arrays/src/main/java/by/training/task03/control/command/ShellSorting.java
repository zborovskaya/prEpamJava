...
public class ShellSorting  implements Command{
    private static final Logger logger = LogManager.getLogger(ShellSorting.class);
    /**
     * The function calls a factory, which gives the necessary Shell sorting
